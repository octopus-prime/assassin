...
node_t const node1(node0, {g5, d8, 0, 1});
node_t const node2(node1, {f8, g7, 0, 0});  // 35. Qd8+ Kg7
node_t const node3(node2, {d8, g5, 0, 1});
node_t const node4(node3, {g7, f8, 0, 0});  // 36. Qg5+ Kf8 (second time)
node_t const node5(node4, {g5, d8, 0, 1});
node_t const node6(node5, {f8, g7, 0, 0});  // 37. Qd8+ Kg7
node_t const node7(node6, {d8, g5, 0, 1});
node_t const node8(node7, {g7, f8, 0, 0});  // 38. Qg5+ Kf8 (third time)
